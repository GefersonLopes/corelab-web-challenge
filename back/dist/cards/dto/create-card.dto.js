...
__decorate([
    (0, swagger_1.ApiProperty)({
        example: 'Aqui está as informações que deverão ser seguidas no projeto HTML',
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'true', description: 'Se o card é favorito' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CreateCardDto.prototype, "isFavorite", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '#FFFFFF', description: 'Cor do card' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateCardDto.prototype, "color", void 0);
